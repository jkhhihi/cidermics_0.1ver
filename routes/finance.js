...
router.get('/finance/profile', function(req, res, next) {
	var finance;
	mysql.select("SELECT COUNT(*) AS appno FROM cider.cid_fi_applyform where fi_app_cate='201702';", function (err, data){
...
router.post('/finance/apply/insert', function(req, res, next) {
	...
	var row;
	var sets = {fi_app_cate : 201702, fi_app_name : fi_app_name, fi_app_phone : fi_app_phone, fi_app_email : fi_app_email, fi_app_job : fi_app_job, fi_app_path : fi_app_path, fi_app_comment : fi_app_comment, fi_app_regDate : date, fi_app_upDate : date, fi_app_age:fi_app_age, fi_app_place:fi_app_place};
